...
<div class="py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
    ...
    <nav class="mb-4 flex items-center space-x-2 text-sm text-gray-500">
        ...
        <span class="text-gray-900">Upload Resource</span>
    </nav>
    ...
    <div class="bg-white shadow-lg rounded-xl border border-gray-200">
        ...
        <div class="p-6">
            <form action="{{ route('resources.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                @csrf
                ...
                <div class="bg-gray-50 rounded-xl p-6 border border-gray-200">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input id="title" name="title" type="text" class="form-input block w-full border-gray-300 rounded-md" required>
                            @error('title')
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" class="form-textarea block w-full border-gray-300 rounded-md" rows="4" required></textarea>
                            @error('description')
                                <p class="mt-2 text-sm text-red-600 flex items-center gap-1">
                                    <i class="bi bi-exclamation-circle"></i>
                                    {{ $message }}
