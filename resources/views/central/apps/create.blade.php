...
<div class="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
    <!-- Breadcrumb -->
    <nav class="mb-2flex items-center space-x-2 text-sm text-gray-500">
        <a href="{{route('apps.index')}}" class="hover:text-gray-700">Apps</a>
        <i class="bi bi-chevron-right text-xs"></i>
        <span class="text-gray-900">Register New</span>
    </nav>
    <!-- Form Container -->
    <div class="bg-white shadow-xl rounded-2xl border border-gray-200 overflow-hidden">
        ...
        <div class="p-6 border-b border-gray-100 flex items-center justify-between">
            <div class="flex items-center gap-3">
                <div class="bg-blue-100 p-2 rounded-lg border border-blue-200">
                    <i class="bi bi-grid-fill text-blue-600 text-xl"></i>
                </div>
        ...
        <!-- Form Body -->
        <div class="p-8">
            <form action="{{route('apps.store')}}" method="POST" class="space-y-10">
                @csrf

                <fieldset class="space-y-10">
                    <legend class="sr-only">App Registration Form</legend>
                    ...
                    <fieldset class="space-y-4">
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input id="base_url" name="base_url" type="url" value="{{ old('base_url') }}" required
                                    class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                            ...
                            <div>
                                ...
                                <input id="icon_url" name="icon_url" type="url" value="{{ old('icon_url') }}"
                                    class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label for="tagline" class="block text-sm font-medium text-gray-700 mb-1">
                                    <i class="bi bi-type mr-1 text-gray-500"></i> Tagline <span class="text-red-500">*</span>
                                </label>
                                <input id="tagline" name="tagline" type="text" value="{{ old('tagline') }}" required
                                    class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                    placeholder="e.g. thriving businesses, property managers, collaborative teams">
                                @error('tagline')
                                    <p class="text-sm text-red-600 mt-1">
                                        <i class="bi bi-exclamation-circle mr-1"></i>{{ $message }}
                                    </p>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="description" name="description" rows="4"
                                    class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                    placeholder="Brief description of the app">{{ old('description') }}</textarea>
                                @error('description')
                                    <p class="text-sm text-red-600 mt-1">
                                        <i class="bi bi-exclamation-circle mr-1"></i>{{ $message }}
                                    </p>
                ...
                <div class="pt-6 border-t border-gray-100 flex justify-end space-x-4">
                    <a href="{{ url()->previous() }}"
                        class="inline-flex items-center px-4 py-2 bg-white text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 border border-gray-300">
                        <i class="bi bi-x-lg mr-2"></i> Cancel
                    </a>
                    <button type="submit"
                        class="inline-flex items-center px-6 py-2 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 border border-blue-600 shadow-sm">
                        <i class="bi bi-plus-lg mr-2"></i> Register App
                    </button>
                </div>
            </form>
        </div>
